// Minimal inline icon set (Heroicons outline style).
// Inline SVGs keep the app dependency-free and let icons inherit text color.
...
export const BanknotesIcon = (p) => (
  <Svg {...p}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M2.25 12.75a60.09 60.09 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V12.75m-16.5 0V9.4c0-.906.632-1.694 1.523-1.858A48.13 48.13 0 0 1 12 6.75c1.918 0 3.797.135 5.633.394 1.049.146 1.867 1.026 1.867 2.086v3.32M4.5 12.75a3.75 3.75 0 1 1 7.5 0 3.75 3.75 0 0 1-7.5 0Z"
    />
  </Svg>
)
